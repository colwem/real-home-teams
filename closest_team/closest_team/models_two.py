...
class HighSchoolT(BaseModel):
    ...
    closest_stadium = IntegerField(db_column='closest_stadium_id', null=True)
    country = CharField(null=True)
    high_school_t = PrimaryKeyField(db_column='high_school_t_id')
    latitude = FloatField(null=True)
    longitude = FloatField(null=True)
    name = CharField(null=True)
    pfr_high_school = CharField(db_column='pfr_high_school_id', null=True, unique=True)
...
class PlayerSeasons(BaseModel):
    ...
    player = ForeignKey(PlayersT, related_name='seasons')
...
class PlayersT(BaseModel):
    ...
    high_school_t = IntegerField(db_column='high_school_t_id', null=True)
    name = CharField(null=True)
    pfr_high_school = CharField(db_column='pfr_high_school_id', null=True)
    pfr_player = CharField(db_column='pfr_player_id', null=True)
...
class Teams(BaseModel):
    ...
    stadium = IntegerField(db_column='stadium_id', null=True)
